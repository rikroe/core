        ...
        try:
            return await self.open_meteo.forecast(
                ...
                daily=[
                    ...
                    DailyParameters.CLOUD_COVER_MEAN,
                    DailyParameters.DEW_POINT_2M_MEAN,
                    DailyParameters.PRECIPITATION_PROBABILITY_MEAN,
                    DailyParameters.PRECIPITATION_SUM,
                    DailyParameters.PRESSURE_MSL_MEAN,
                    DailyParameters.RELATIVE_HUMIDITY_2M_MEAN,
                    DailyParameters.TEMPERATURE_2M_MAX,
                    DailyParameters.TEMPERATURE_2M_MIN,
                    DailyParameters.UV_INDEX_MAX,
